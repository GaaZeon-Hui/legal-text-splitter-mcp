...
def _build_pretext_table(fragments):
    ...
    ui.html(
        ...
        '.pt-t th{padding:8px 12px;text-align:left;font-weight:500;font-size:12px;'
        'color:#888;border-bottom:2px solid #ddd;'
        'border-right:1px solid #eee}'
        '.pt-t th:last-child{border-right:none}'
        '.pt-t td{padding:8px 12px;text-align:left;'
        'border-bottom:1px solid #f0f0f0;border-right:1px solid #f0f0f0;'
        'overflow:hidden;text-overflow:ellipsis;white-space:nowrap}'
        '.pt-t td:last-child{border-right:none}'
        '.pt-t tbody tr{cursor:pointer}'
        '.pt-t tbody tr:hover td{background:#fafafa}'
        '.pt-c1{width:44px}.pt-c3{width:72px}.pt-c4{width:56px}.pt-c5{width:88px}'
        '</style>'
