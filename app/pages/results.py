...
def _build_result_table(fragments):
    ...
    html = (
        '<style>'
        '@import url("https://fonts.googleapis.com/css2?family=Inter:400,500,600&display=swap");'
        '.st{'
        ...
        '.st tbody tr:hover td{color:#000}'
        '.cs{padding-left:4px!important;width:36px}'
        '.ct{width:64px}.cl{width:40px}.co{width:76px}'
        '.cc{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-right:12px!important}'
        '</style>'
        '<table class="st"><thead><tr>'
        '<th class="cs">#</th><th class="cc">内容</th>'
